...
public class ScheduleJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) {
        ThreadPoolTaskExecutor scheduleJobExecutorService = new ThreadPoolTaskExecutor();
        scheduleJobExecutorService = SpringContextUtil.getBean(ThreadPoolTaskExecutor.class);
...
//        IJobLogService scheduleJobLogService = SpringContextUtil.getBean(IJobLogService.class);
        IJobLogService scheduleJobLogService;
        scheduleJobLogService = SpringContextUtil.getBean(IJobLogService.class);
